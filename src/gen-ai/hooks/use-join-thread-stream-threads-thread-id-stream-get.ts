...
import { joinThreadStreamThreadsThreadIdStreamGet } from "@/gen-ai/client/join-thread-stream-threads-thread-id-stream-get";
import type {
...
export const joinThreadStreamThreadsThreadIdStreamGetQueryKey = (
...
export type JoinThreadStreamThreadsThreadIdStreamGetQueryKey = ReturnType<
  typeof joinThreadStreamThreadsThreadIdStreamGetQueryKey
>;

export function joinThreadStreamThreadsThreadIdStreamGetQueryOptions(
  thread_id: JoinThreadStreamThreadsThreadIdStreamGetPathParams["thread_id"],
  params?: JoinThreadStreamThreadsThreadIdStreamGetQueryParams,
...
export function useJoinThreadStreamThreadsThreadIdStreamGet<
  ...
  TQueryData = JoinThreadStreamThreadsThreadIdStreamGetQueryResponse,
  TQueryKey extends QueryKey = JoinThreadStreamThreadsThreadIdStreamGetQueryKey,
>(
  thread_id: JoinThreadStreamThreadsThreadIdStreamGetPathParams["thread_id"],
  params?: JoinThreadStreamThreadsThreadIdStreamGetQueryParams,
  headers?: JoinThreadStreamThreadsThreadIdStreamGetHeaderParams,
  ...
  const queryKey =
    queryOptions?.queryKey ?? joinThreadStreamThreadsThreadIdStreamGetQueryKey(thread_id, params);

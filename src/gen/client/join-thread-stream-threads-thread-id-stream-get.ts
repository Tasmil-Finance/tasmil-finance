...
function getJoinThreadStreamThreadsThreadIdStreamGetUrl(thread_id: JoinThreadStreamThreadsThreadIdStreamGetPathParams["thread_id"]) {
 ...
 */
export async function joinThreadStreamThreadsThreadIdStreamGet(thread_id: JoinThreadStreamThreadsThreadIdStreamGetPathParams["thread_id"], params?: JoinThreadStreamThreadsThreadIdStreamGetQueryParams, headers?: JoinThreadStreamThreadsThreadIdStreamGetHeaderParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  const { client: request = fetch, ...requestConfig } = config  
  
  const res = await request<JoinThreadStreamThreadsThreadIdStreamGetQueryResponse, ResponseErrorConfig<JoinThreadStreamThreadsThreadIdStreamGet404 | JoinThreadStreamThreadsThreadIdStreamGet422>, unknown>({ method : "GET", url : getJoinThreadStreamThreadsThreadIdStreamGetUrl(thread_id).url.toString(), params, ... requestConfig, headers : { ...headers, ...requestConfig.headers } })  
  return res.data
}
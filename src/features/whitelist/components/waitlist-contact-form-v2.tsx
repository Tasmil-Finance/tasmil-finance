      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start">
        ...
        <div className="relative flex-1">
          <Input
            ...
            className={`h-11 w-full rounded-xl border bg-background px-3 py-2 pr-10 text-sm text-foreground placeholder:text-muted-foreground transition-colors duration-200 ${
              email.length > 0
                ? emailValid
          ...
          {email.length > 0 && emailValid && (
            <div className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 animate-stepper-pop">
              <svg

...
export const AGENTS: Record<string, AgentConfig> = {
  ...
  staking_agent: {
    ...
    capabilities: ["build_transaction", "query_contract", "submit_transaction", "get_supported_chains"],
  },
  ...
  bridge_agent: {
    ...
    supportedChains: ["Ethereum", "Arbitrum", "Optimism", "Polygon", "BSC", "Avalanche", "Base", "Linea", "U2U Solaris"],
    suggestions: [

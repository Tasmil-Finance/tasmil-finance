        ...
        <div className="animate-in fade-in-0 zoom-in-95 bg-background flex max-w-3xl flex-col rounded-lg border shadow-lg">
          ...
          <form
            onSubmit={(e) => {
              ...
              const apiUrlValue = formData.get("apiUrl") as string;
              const assistantIdValue = formData.get("assistantId") as string;
              const apiKeyValue = formData.get("apiKey") as string;

              setApiUrl(apiUrlValue);
              setApiKey(apiKeyValue);
              setAssistantId(assistantIdValue);
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground text-sm">
                This is the ID of the graph or assistant to invoke.
              </p>
              <Input
                id="assistantId"
                name="assistantId"
